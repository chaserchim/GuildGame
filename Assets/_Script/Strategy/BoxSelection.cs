...
public class BoxSelection : SelectionStrategy
{
    ...
    public void SelectFromBottomLeftCorner(SelectionData selectionData, Vector3Int tempPos, Vector2Int minPoint, Vector2Int maxPoint)
    {
    ...
    /// <param name="minPoint"></param>
    /// <param name="maxPoint"></param>
    public void SelectFromBottomRightCorner(SelectionData selectionData, Vector3Int tempPos, Vector2Int minPoint, Vector2Int maxPoint)
    {
    ...
    /// <param name="minPoint"></param>
    /// <param name="maxPoint"></param>
    public void SelectFromTopLeftCorner(SelectionData selectionData, Vector3Int tempPos, Vector2Int minPoint, Vector2Int maxPoint)
    {
        foreach (int x in GridSelectionHelper.MoveMinToMaxInclusive(minPoint.x, maxPoint.x, selectionData.PlacedItemData.size.x))
        {
    ...
    /// <param name="minPoint"></param>
    /// <param name="maxPoint"></param>
    public void SelectFromTopRightCorner(SelectionData selectionData, Vector3Int tempPos, Vector2Int minPoint, Vector2Int maxPoint)
    {
        foreach (int x in GridSelectionHelper.MoveMaxToMinInclusive(minPoint.x, maxPoint.x, selectionData.PlacedItemData.size.x))
        {
            foreach (int y in GridSelectionHelper.MoveMaxToMinInclusive(minPoint.y, maxPoint.y, selectionData.PlacedItemData.size.y))
    ...
    public void AddToSelection(Vector3Int position, SelectionData selectionData)
    {
